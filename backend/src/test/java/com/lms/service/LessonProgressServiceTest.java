...
class LessonProgressServiceTest {
    ...
    void getCompletionPercentage_WhenPartiallyComplete_ShouldReturnPercentage() {
        // Arrange
        ...
        // Act
        double percentage = lessonProgressService.getCompletionPercentage(course.getId());
    ...
    @Test
    @DisplayName("Should return 0 when no lessons completed")
    void getCompletionPercentage_WhenNoCompleted_ShouldReturnZero() {
        // Arrange
        when(authService.getCurrentUser()).thenReturn(student);
        when(enrollmentRepository.findByStudentAndCourse(eq(student), any(Course.class)))
                .thenReturn(Optional.of(enrollment));
    ...
    @Test
    @DisplayName("Should return 100 when all lessons completed")
    void getCompletionPercentage_WhenAllCompleted_ShouldReturn100() {
        // Arrange
        progress1.setCompleted(true);
